  ...
  return (
    <div className="bg-rose-gold dark:bg-maroon-outer min-h-screen flex flex-col">
      <div className="container mx-auto max-w-4xl bg-white dark:bg-maroon-container shadow-lg min-h-screen flex flex-col">
        ...
        <main className="flex-1 p-3 flex flex-col gap-4 min-h-0 text-gray-900 dark:text-maroon-text bg-white dark:bg-[#232323]">
          {children}
        </main>
        <footer className="footer bg-rose-gold dark:bg-[#232323] text-gray-600 dark:text-maroon-text text-center py-2 text-sm mt-auto">
